...
function search(text,nick,site){
	...
	if(jsonSquad[0].value==0) //console.log("nunca ganhou squad")
		...
		var resultado = "DIRETO DO HEROKU\r\n>> "+nick+" Squad <<\r\nWins: "+jsonSquad[0].value+separador+"Win %: "+jsonSquad[8].value +separador+"Kills: "+jsonSquad[10].value +quebraLinha+ site +quebraLinha+ creditos;
