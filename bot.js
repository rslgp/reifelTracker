    ...
    if(head === null){
		...
		if(node.element.elo > head.element.elo){
			...
			while(currentNode.next){
				if(node.element.nick == currentNode.element.nick && node.element.elo !== currentNode.element.elo ) {reifelUser.send(posicaoLista); currentNode.element.elo = node.element.elo; this.add(this.removeAt(posicaoLista)); return;}
