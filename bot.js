...
function msgImgApex(message, valoresJimp=["---","---","---"]){//winrate, kd, wins, kills, trn
	...
	copiaJimp.print(fontJimp, 12,linha1, valoresJimp[0])	
		...
		.write(tempFile, function(){
			...
			if(message.member.nickname.contains(message.content.substring(3)) message.member.send("[comando dk] reaja com as lendas na sequencia de mais jogado ao menos, embaixo da foto resultado (pra onde o emoji aponta)(clica reagir e busca o nome da lenda, no maximo 3)");
		});
	copiaJimp=null;
}
